...
appCopy.nl.scrollText = 'Veeg over de letters om opzij te schuiven. Sleep de gele cirkel om te schrijven.';
appCopy.en.scrollText = 'Swipe on the letters to move sideways. Drag the yellow circle to write.';
appCopy.fa.scrollText = 'برای جابه‌جایی روی حروف بکش. برای نوشتن، دایرهٔ زرد را بکش.';
