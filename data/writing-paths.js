...
export const writingPaths = {
  ...
  'capital-b': letter(['M 85 70 V 425 C 265 425 280 260 125 260 C 290 250 275 70 85 70']),
  'capital-c': letter(['M 285 115 C 225 55 90 75 75 245 C 65 415 225 455 290 385']),
  'capital-d': letter(['M 85 70 V 425 C 335 425 335 70 85 70']),
  ...
  'capital-o': letter(['M 180 65 C 55 65 55 435 180 435 C 305 435 305 65 180 65']),
  'capital-p': letter(['M 85 425 V 75 H 190 C 320 75 320 255 190 255 H 85']),
  'capital-q': letter(['M 170 65 C 45 65 45 435 170 435 C 295 435 295 65 170 65', 'M 215 330 L 305 425']),
